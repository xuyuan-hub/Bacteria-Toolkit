...
def train(
    hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/images/dish/train/data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--noautoanchor',default='True',action='store_true', help='disable AutoAnchor')
